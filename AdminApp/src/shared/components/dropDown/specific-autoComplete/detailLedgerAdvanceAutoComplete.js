...
class DetailLedgerAdvanceAutoCompleteComponent extends React.Component {
    constructor(props) {
        super(props);
                                ...
                                <Grid item md={3}>
                                    <Fieldset style={{ marginTop: "-3px !important" }} className={"fieldset-in-search"} legend={'جستجو بر اساس مشخصات'}>
                                        ...
                                        <Grid container spacing={8} className="no-margin">
                                            ...
                                            <Grid item md={11}>
                                                <Input label="شماره حساب" isLeftStartText={true} handleChange={(e) => this.handleChange(e, 'accountCode')} value={this.state.accountCode} required />
                                            </Grid>
                                        </Grid>
...
DetailLedgerAdvanceAutoCompleteComponent.defaultProps = {
...
export default withStyles(styles)(DetailLedgerAdvanceAutoCompleteComponent);