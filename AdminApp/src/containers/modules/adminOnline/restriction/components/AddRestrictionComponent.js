...
import AddRestrictionService from '../services/AddRestrictionService';
...
class AddRestrictionComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <React.Fragment>
                ...
                <Form
                    {...this.props}
                    {...this.state}
                    service={AddRestrictionService.addBrokerRule}
                    entity={
                        {
...
export default withStyles(styles)(AddRestrictionComponent);