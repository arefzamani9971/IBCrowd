...
import EditRestrictionService from '../services/EditRestrictionService';
...
class EditRestrictionComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <React.Fragment>
                ...
                <Form
                    {...this.props}
                    {...this.state}
                    service={EditRestrictionService.updateBrokerRule}
                    entity={
                        {
...
export default withStyles(styles)(EditRestrictionComponent);