...
const Columns = function (props, state, classes) {
    return [
        ...
        //         let edit = event.dataItem.party.partyType === 1 ? props.editUncompleted[0] : props.editUncompleted[1];
