...
import SaveCustomerTradingCodeSerivces from '../../customerTradingCodes/services/SaveCustomerTradingCodeSerivces';
...
class CreateCustomersTradingCodesComponentTab extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //TSE
            ...
            <React.Fragment>
                <Header {...this.props} backParams={
                    this.props.location.state === undefined ? undefined : {
                        ...
                        // title : 'بازگشت به تب کد های معاملاتی مشتری',
                                        ...
                                        <Grid container spacing={16} className="no-margin">
                                            <Grid item md={3}>
                                                <Input label="پم کد معاملات بورسی اوراق" handleChange={(e) =>
                                                    ...
                                                    disabled={!this.state.party.isForeignCustomer}/>
                                            </Grid>
                                            <Grid item md={3}>
...
export default withStyles(styles)(CreateCustomersTradingCodesComponentTab)