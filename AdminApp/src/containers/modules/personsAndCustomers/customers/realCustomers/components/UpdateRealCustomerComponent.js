...
const initialState = {
    ...
    isIbanCorrect: true,
    serviceName: "updateRealCustomer",
    ...
    successGetCustomerById(response) {
        if (response.success) {
            ...
            this.setState({
                ...
                birthDate: res.party.birthDateJalali !== '' ? res.party.birthDate : null,
        ...
        return (
            <React.Fragment>
                ...
                <Form
                    {...this.props}
                    {...this.state}
                    service={EditRealCustomerService[this.state.serviceName]}
                    SubmitTitle={'ذخیره'}
                    disabled={this.state.firstName == '' || this.state.firstName == null || this.state.lastName == '' || this.state.lastName == null ||
                        ...
                        this.state.mainMarket.length == 0 || this.state.birthDate == null || this.state.branch.id == 0 || !this.state.isIbanCorrect}
                    ...
                    <Fieldset legend={'اطلاعات فردی'}>
                        ...
                        <Grid container spacing={16} className="no-margin">
                            <Grid item md={2}>
                                <PersianDatePicker label="تاریخ تولد" handleOnChange={this.handleBirthDate} selectedDate={this.state.birthDate} required />
                            </Grid>
                            <Grid item md={3}>
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(EditRealCustomer));