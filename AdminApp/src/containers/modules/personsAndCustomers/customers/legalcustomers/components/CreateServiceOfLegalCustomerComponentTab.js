...
class CreateServiceOfLegalCustomerComponentTab extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            getServices: {
...
CreateServiceOfLegalCustomerComponentTab.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(CreateServiceOfLegalCustomerComponentTab);