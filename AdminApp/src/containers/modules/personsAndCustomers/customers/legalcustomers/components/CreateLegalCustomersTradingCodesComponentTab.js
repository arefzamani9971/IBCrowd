...
class CreateLegalCustomersTradingCodesComponentTab extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            //TSE
...
export default withStyles(styles)(CreateLegalCustomersTradingCodesComponentTab)