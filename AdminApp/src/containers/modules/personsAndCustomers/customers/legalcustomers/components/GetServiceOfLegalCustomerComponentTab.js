...
import Columns from '../constants/GetServiceOfLegalCustomerColumnsTab';
import Grid from '@material-ui/core/Grid';
import './GetServiceOfLegalCustomerComponentTab.css';
...
class GetServiceOfLegalCustomerComponentTab extends React.Component {
    ...
    getTradeList = () => {
        ...
        $("#customersServiceListForLegalCustomer").kendoGrid({
            dataSource: {
                transport: {
            ...
            dataBound: function (e) {
                ...
                if (this.dataSource.data().length > 0) {
                    let grid = $("#customersServiceListForLegalCustomer").data("kendoGrid");
        ...
        $("#customersServiceListForLegalCustomer #delete").on("click", function (item) {
        ...
        $("#customersServiceListForLegalCustomer #add").on("click", function () {
        ...
        $("#customersServiceListForLegalCustomer #edit").on("click", function () {
            self.setState({
                editModal: true,
            })
        });
        $("#customersServiceListForLegalCustomer #editActivation").on("click", function () {
            self.setState({
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Paper className="main-paper-container customersServiceListForLegalCustomer">
                    <Filter
                        search={this.search}
                    ...
                    <div className={"k-rtl " + (this.state.open ? "height-open-grid" : "height-content-grid")}>
                        <div id="customersServiceListForLegalCustomer" className="height-page"></div>
                    </div>
                </Paper>
                <Modal
...
export default GetServiceOfLegalCustomerComponentTab;
