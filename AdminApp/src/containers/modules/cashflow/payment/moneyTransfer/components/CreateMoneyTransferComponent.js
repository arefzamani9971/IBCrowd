...
class CreateMoneyTransferComponent extends React.Component {
    constructor(props) {
        super(props);
             ...
             <Grid container spacing={8} className="no-margin">
                <Grid item md={6}>
                        <AutoCompleteComponent {...this.state.partyTransmitter}
                                        handleChange={(value) => this.handlePartyChange(value, 'selectedPartyTransmitter')}
                ...
                <Grid item md={6}>
                        <AutoCompleteComponent {...this.state.partyReceiver}
                                        handleChange={(value) => this.handlePartyChange(value, 'selectedPartyReceiver')}
        ...
        return (
            <React.Fragment>
                ...
                <Form
                    {...this.props}
                    {...this.state}
                    service={GetMoneyTransferServices.savetransferMethod}
                    entity={
                        {
                            transferType: this.state.selectedTransferType.code,
                            fromPartyId: this.state.selectedPartyTransmitter.id,
                            toPartyId: this.state.selectedPartyReceiver.id,
                            ...
                            amount: this.state.price ? parseInt(this.state.price.replace(/,/g, '')) : 0,
...
export default CreateMoneyTransferComponent;